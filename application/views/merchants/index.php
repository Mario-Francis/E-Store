...
<head>
	...
	<title>
		<?php echo $title; ?> | Ex-Gstores</title>
</head>
...
<body class="bg-light">
		...
		<div class="row">
			<div class="offset-sm-3 col-sm-6 offset-md-4 col-md-4 mcard p-0 bg-white">
				<div class="p-3">
                    ...
                    <h6 class="text-center m-0 mt-2 text-dark" style="font-family:verdana;">Merchant</h6>
				</div>
				<div class="p-3 pl-md-4 pr-md-4">
				<form id="loginForm">
                    <p class="txtlab mt-4 text-center">Email</p>
                    <input type="text" id="email" class="form-control rounded-0 mtxtbx text-center" required />
					...
					<!-- <p class="txtlab mt-4">Email</p>
					<input type="text" id="email" class="form-control rounded-0 mtxtbx" />
					<p class="txtlab mt-3">Password</p>
					<input type="password" id="pswd" class="form-control rounded-0 mtxtbx" />
					...
					<p class="text-center mt-4">
						<a href="javascript:void(0)" id="lbtn" class="btn vbtn txt-morange rounded-0 mcard" style="min-width:120px;">Submit</a>
					</p> -->
				</div>
			</div>
		</div>
	...
	<script src="<?php echo base_url('scripts/merchant_login.js'); ?>"></script>
