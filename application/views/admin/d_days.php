<div class="row mt-4">
	<div class="offset-sm-3 col-sm-6 bg-white p-0 mcard">
		<div class="bg-morange p-3">
			<h4 class="mb-0">Set Delivery Days</h4>
		</div>

		<form class="form-group p-3 p-sm-4">
            <div class="myinfo p-3 txt-sec small">
                <p>This section allows you set the range of days for an order to be delivered.</p>
            </div>
			<p class="txtlab mt-3">Days</p>
			<input type="number" max="30" min="0" id="rate" class="form-control mtxtbx" disabled value="<?php echo $rate; ?>" />
