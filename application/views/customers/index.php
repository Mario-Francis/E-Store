...
<div class="row mt-3 mb-4">
	<div class="offset-sm-1 col-12 col-sm-10 p-3">
		<h5 class="shd text-dark">Newly Arrived Products</h5>
		<hr class="hr mt-2 mb-3" />
		<?php if($r_count > 0){ ?>
		<div class="row">
			<?php foreach($r_products as $p){ ?>
		...
		<div class="row">
			<div class="offset-sm-1 col-12 col-sm-10 p-3">
				<p class="text-center">
					<a href="<?php echo base_url('customers/recently_added'); ?>" class="btn vbtn txt-morange rounded-0 mcard">View More</a>
				</p>
			</div>
		</div>
		<?php }}else{ ?>
		<div class="row">
			<div class="offset-sm-1 col-sm-10 col-12">
				<div class="myinfo p-3">
					<p class="txt-sec text-center">No items found!</p>
				</div>
			</div>
		</div>
		<?php } ?>
...
<div class="row mt-3 mb-4">
	<div class="offset-sm-1 col-12 col-sm-10 p-3">
		<h5 class="shd text-dark">Special Offers</h5>
		<hr class="hr mt-2 mb-3" />
		
		<div class="row">
			<?php foreach($s_products as $p){ ?>
			<div class="col-lg-2 col-md-3 col-sm-4 col-6 p-2">
				<div class="p-2 bg-morange mcard prod" pid="<?php echo $p['id']; ?>" onclick="nav(this);">
					<div class="bg-white" style="overflow:hidden;">
						<img src="<?php echo base_url($p['image']['fpath']); ?>" class="img-fluid pimg" />
				...
				<center>
					<div class="cartbtn bg-white rounded-circle mcard" data="<?php echo $p['data']; ?>" onclick="addToCart(this);">
						<div class="bg-mblue rounded-circle">
							<img src="<?php echo base_url('images/cart.png'); ?>" class="img-fluid" />
						</div>
					</div>
		...
		<div class="row">
			<div class="offset-sm-1 col-12 col-sm-10 p-3">
				<p class="text-center">
					<a href="<?php echo base_url('customers/special_offers'); ?>" class="btn vbtn txt-morange rounded-0 mcard">View More</a>
				</p>
			</div>
		</div>
		<?php } ?>
...
<div class="row mt-3 mb-4">
	<div class="offset-sm-1 col-12 col-sm-10 p-3">
		<h5 class="shd text-dark">Most Picked Items</h5>
		<hr class="hr mt-2 mb-3" />
		
		<div class="row">
			<?php foreach($m_products as $p){ ?>
			<div class="col-lg-2 col-md-3 col-sm-4 col-6 p-2">
				<div class="p-2 bg-morange mcard prod" pid="<?php echo $p['id']; ?>" onclick="nav(this);">
					<div class="bg-white" style="overflow:hidden;">
						<img src="<?php echo base_url($p['image']['fpath']); ?>" class="img-fluid pimg" />
		...
		<div class="row">
			<div class="offset-sm-1 col-12 col-sm-10 p-3">
				<p class="text-center">
					<a href="<?php echo base_url('customers/most_picked'); ?>" class="btn vbtn txt-morange rounded-0 mcard">View More</a>
				</p>
			</div>
		</div>
		<?php } ?>
